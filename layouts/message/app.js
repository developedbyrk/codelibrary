function insetSuggestedMessage() {
  ...
  let newElementText = document.createTextNode(
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores quaerat sed facere voluptate doloremque. Commodi, in? Mollitia voluptatibus quos id tenetur omnis veniam aut ea."
  );
...
function toggleSuggestedMessage() {
  document
    .querySelector(".suggested-message")
    .classList.toggle("toggle-message");
}
